...
public class OBControllerWithList : UIViewController {
    ...
    func changeSubviewsForOrientation() {
        ...
        if windowScene.effectiveGeometry.interfaceOrientation.isPortrait || !iPhone {
    ...
    func addConstraintsForPad() {
        ...
        if let tertiaryTextLabel {
            ...
            constraints.portrait.append(contentsOf: [
                stackView.bottom.constraint(equalTo: subviewToAddSubviews.safeAreaLayoutGuide.bottom, constant: -20.0)
            ])
        }
